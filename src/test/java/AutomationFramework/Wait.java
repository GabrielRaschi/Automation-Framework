...
public class Wait {
    ...
    public static WebElement clickable(WebDriver driver, By locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.elementToBeClickable(locator));
    }
    ...
    public static WebElement presence(WebDriver driver, By locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.presenceOfElementLocated(locator));
    }

    public static WebElement visible(WebDriver driver, By locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.visibilityOfElementLocated(locator));
    }

    public static WebElement visible(WebDriver driver, WebElement locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.visibilityOf(locator));
    }
    ...
    public static boolean invisible(WebDriver driver, By locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.invisibilityOfElementLocated(locator));
    }

    public static boolean notClickable(WebDriver driver, WebElement locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.not(ExpectedConditions.elementToBeClickable(locator)));
    }

    public static boolean notInvisible(WebDriver driver, By locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.not(ExpectedConditions.invisibilityOfElementLocated(locator)));
    }

    public static Alert alert(WebDriver driver) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.alertIsPresent());
    }
    ...
    public static WebDriver frame(WebDriver driver, By locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(locator));
    }
    ...
    public static boolean textContains(WebDriver driver, String id, String text) {
        return new WebDriverWait(driver, DataItems.maximWait).until(CommonTask.textContains(id, text));
    }

    public static boolean checked(WebDriver driver, By locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(CommonTask.boxIsChecked(driver.findElement(locator)));
    }
    ...
    public static boolean notChecked(WebDriver driver, By locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(CommonTask.boxIsNotChecked(driver.findElement(locator)));
    }

    public static boolean unchecked(WebDriver driver, By locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(CommonTask.boxIsUnchecked(driver.findElement(locator)));
    }

    public static boolean textPresent(WebDriver driver, By locator, String text) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.textToBePresentInElementLocated(locator, text));
    }

    public static boolean textPresent(WebDriver driver, WebElement locator, String text) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.textToBePresentInElement(locator, text));
    }

    public static boolean textNotPresent(WebDriver driver, WebElement locator, String text) {
        return new WebDriverWait(driver, DataItems.maximWait).until(ExpectedConditions.not(ExpectedConditions.textToBePresentInElement(locator, text)));
    }

    public static boolean textPresentInput(WebDriver driver, By locator, String text) {
        return new WebDriverWait(driver, DataItems.maximWait).until(CommonTask.textToBePresentInput(locator,text));
    }
    ...
    public static boolean textPresentInput2(WebDriver driver, String element, String text) {
        return new WebDriverWait(driver, DataItems.maximWait).until(CommonTask.textToBePresentInput2(element,text));
    }
    public static boolean textPresentInput3(WebDriver driver, String element, String text) {
        return new WebDriverWait(driver, DataItems.maximWait).until(CommonTask.textToBePresentInput3(element,text));
    }

    public static boolean selectionPresent(WebDriver driver, By locator) {
        return new WebDriverWait(driver, DataItems.maximWait).until(CommonTask.selectionToBePresent(locator));
    }

    public static boolean selectionToBe(WebDriver driver, By locator, String selection) {
        return new WebDriverWait(driver, DataItems.maximWait).until(CommonTask.selectionToBe(locator, selection));
    }
    ...
    public static boolean optionPresent(WebDriver driver, By locator, String option) {
        ...
        return new WebDriverWait(driver, DataItems.maximWait).until(CommonTask.optionPresent(option, select));
    }
